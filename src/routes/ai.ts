...
export const aiRoutes = async (app: FastifyInstance) => {
  app.withTypeProvider<ZodTypeProvider>().route({
    ...
    handler: async (request, reply) => {
      ...
      // Extrair as mensagens do corpo da requisição vindo do cliente
      ...
      const result = streamText({
        ...
        // Definir as ferramentas disponíveis para a IA, incluindo as operações de treino e plano de treino
        tools: {
          ...
          // A IA usará essa ferramenta para criar um novo plano de treino com base nas informações
          // fornecidas pelo usuário e seguindo as regras definidas no prompt.
          // A descrição deve ser clara para a IA entender quando e como usar essa ferramenta.
      ...
      // Propagar os headers do stream para o cliente (ex: Content-Type: text/event-stream)
